<script type="text/x-template" id="container-template">
    <v-row align="center" justify="center">
      <v-card width="400" class="transparent" flat>
        <v-card-title class="title font-weight-bold justify-center pt-8" style="color: #009d39;">LOGIN MEMBER</v-card-title>
        <v-card-text>
        ...
        methods: {
            async doLogin() {
                ...
                if (isValid) {
                    ...
                    await axios
                        .post("<?php echo site_url('login/verify'); ?>", this.form)
                        .then((response) => {
